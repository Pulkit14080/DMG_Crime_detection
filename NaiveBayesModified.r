naiveBayesModified <- function(x, ...)
  UseMethod("naiveBayesModified")

naiveBayesModified.default <- function(x, y, laplace = 0, ...) {
  call <- match.call()
...
naiveBayesMod.formula <- function(formula, data, laplace = 0, ...,
